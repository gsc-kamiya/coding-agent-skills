...
Write-Host ""
Write-Host "  1. " -ForegroundColor Cyan -NoNewline; Write-Host "GitHub にログイン (まだの場合):"
Write-Host "       gh auth login" -ForegroundColor White
Write-Host ""
Write-Host "  2. " -ForegroundColor Cyan -NoNewline; Write-Host "好きなコーディングエージェントを起動:"
...
Write-Host ""
Write-Host "  3. " -ForegroundColor Cyan -NoNewline; Write-Host "起動したエージェント内でスキルを呼び出す:"
Write-Host "       /agent-setup-check     # 環境確認" -ForegroundColor White
